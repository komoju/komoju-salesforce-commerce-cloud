...
var cancelOrderKomoju = LocalServiceRegistry.createService('KOMOJUCancelAndRefundService', {
    createRequest: function (svc, params) {
        ...
        var customUrl = baseURL + '/payments/' + params + '/cancel';
...
module.exports = {
    cancelOrderKomoju: cancelOrderKomoju
};
